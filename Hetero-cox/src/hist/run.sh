...
clang++ -std=c++11 cuda/hist_cuda_benchmark.cu -I../.. --cuda-path=/usr/local/cuda-10.1 \
...
g++ -o hist -fPIC -no-pie -L/home/robinhan/repo/open_source_template/build/runtime \
