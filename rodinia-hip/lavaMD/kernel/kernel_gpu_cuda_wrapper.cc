...
#include "./kernel_gpu_cuda.cc"						// (in the current directory)	GPU kernel, cannot include with header file because of complications with passing of constant memory variables
						...
						FOUR_VECTOR* fv_cpu)
{
	...
	hipLaunchKernelGGL(kernel_gpu_cuda, blocks, threads, 0, 0, 	par_cpu,
											dim_cpu,
											d_box_gpu,
											d_rv_gpu,
											d_qv_gpu,
