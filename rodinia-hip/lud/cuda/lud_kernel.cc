...
lud_cuda(float *m, int matrix_dim)
{
  ...
  for (i=0; i < matrix_dim-BLOCK_SIZE; i += BLOCK_SIZE) {
      hipLaunchKernelGGL(lud_diagonal, 1, BLOCK_SIZE, 0, 0, m, matrix_dim, i);
      hipLaunchKernelGGL(lud_perimeter, (matrix_dim-i)/BLOCK_SIZE-1, BLOCK_SIZE*2, 0, 0, m, matrix_dim, i);
      ...
      hipLaunchKernelGGL(lud_internal, dimGrid, dimBlock, 0, 0, m, matrix_dim, i); 
  }
  hipLaunchKernelGGL(lud_diagonal, 1, BLOCK_SIZE, 0, 0, m, matrix_dim, i);
