...
#define C_PACK_INTERFACE(operation, dir)                                                                     \
    extern "C" void operation##_##dir##_buffers_cuda_(int *xmin, int *xmax, int *ymin, int *ymax,            \
...
void CloverleafCudaChunk::packRect(double *host_buffer, dir_t direction,
...
void CloverleafCudaChunk::packBuffer(const int which_array,
...
#define CALL_PACK(dev_ptr, type, face, dir)                                                                      \
    {                                                                                                            \
        ...
        device_pack##face##Buffer<<<launch_sz, BLOCK_SZ>>>(x_min, x_max, y_min, y_max, type,                     \
...
#define PACK_CUDA_BUFFERS(dev_ptr, type)                             \
    ...
    {
    case FIELD_density0:
        PACK_CUDA_BUFFERS(density0, CELL);
        break;
    case FIELD_density1:
        PACK_CUDA_BUFFERS(density1, CELL);
        break;
    case FIELD_energy0:
        PACK_CUDA_BUFFERS(energy0, CELL);
        break;
    case FIELD_energy1:
        PACK_CUDA_BUFFERS(energy1, CELL);
        break;
    case FIELD_pressure:
        PACK_CUDA_BUFFERS(pressure, CELL);
        break;
    case FIELD_viscosity:
        PACK_CUDA_BUFFERS(viscosity, CELL);
        break;
    case FIELD_soundspeed:
        PACK_CUDA_BUFFERS(soundspeed, CELL);
        break;
    case FIELD_xvel0:
        PACK_CUDA_BUFFERS(xvel0, VERTEX_X);
        break;
    case FIELD_xvel1:
        PACK_CUDA_BUFFERS(xvel1, VERTEX_X);
        break;
    case FIELD_yvel0:
        PACK_CUDA_BUFFERS(yvel0, VERTEX_Y);
        break;
    case FIELD_yvel1:
        PACK_CUDA_BUFFERS(yvel1, VERTEX_Y);
        break;
    case FIELD_vol_flux_x:
        PACK_CUDA_BUFFERS(vol_flux_x, X_FACE);
        break;
    case FIELD_vol_flux_y:
        PACK_CUDA_BUFFERS(vol_flux_y, Y_FACE);
        break;
    case FIELD_mass_flux_x:
        PACK_CUDA_BUFFERS(mass_flux_x, X_FACE);
        break;
    case FIELD_mass_flux_y:
        PACK_CUDA_BUFFERS(mass_flux_y, Y_FACE);
        break;
    default:
        DIE("Invalid which_array identifier '%d' passed to CUDA - valid range is %d-%d", which_array, FIELD_density0, FIELD_mass_flux_y);
    }
...
void CloverleafCudaChunk::unpackBuffer(const int which_array,
                                       const int which_side,
                                       double *buffer,
                                       const int buffer_size,
                                       const int depth)
...
#define CALL_UNPACK(dev_ptr, type, face, dir)                                                                    \
    {                                                                                                            \
        ...
        cudaDeviceSynchronize();                                                                                 \
        const int launch_sz = (ceil((dir##_max + 4 + type.dir##_extra) / static_cast<float>(BLOCK_SZ))) * depth; \
        device_unpack##face##Buffer<<<launch_sz, BLOCK_SZ>>>(x_min, x_max, y_min, y_max, type,                   \
...
#define UNPACK_CUDA_BUFFERS(dev_ptr, type)                             \
    ...
    {
    case FIELD_density0:
        UNPACK_CUDA_BUFFERS(density0, CELL);
        break;
    case FIELD_density1:
        UNPACK_CUDA_BUFFERS(density1, CELL);
        break;
    case FIELD_energy0:
        UNPACK_CUDA_BUFFERS(energy0, CELL);
        break;
    case FIELD_energy1:
        UNPACK_CUDA_BUFFERS(energy1, CELL);
        break;
    case FIELD_pressure:
        UNPACK_CUDA_BUFFERS(pressure, CELL);
        break;
    case FIELD_viscosity:
        UNPACK_CUDA_BUFFERS(viscosity, CELL);
        break;
    case FIELD_soundspeed:
        UNPACK_CUDA_BUFFERS(soundspeed, CELL);
        break;
    case FIELD_xvel0:
        UNPACK_CUDA_BUFFERS(xvel0, VERTEX_X);
        break;
    case FIELD_xvel1:
        UNPACK_CUDA_BUFFERS(xvel1, VERTEX_X);
        break;
    case FIELD_yvel0:
        UNPACK_CUDA_BUFFERS(yvel0, VERTEX_Y);
        break;
    case FIELD_yvel1:
        UNPACK_CUDA_BUFFERS(yvel1, VERTEX_Y);
        break;
    case FIELD_vol_flux_x:
        UNPACK_CUDA_BUFFERS(vol_flux_x, X_FACE);
        break;
    case FIELD_vol_flux_y:
        UNPACK_CUDA_BUFFERS(vol_flux_y, Y_FACE);
        break;
    case FIELD_mass_flux_x:
        UNPACK_CUDA_BUFFERS(mass_flux_x, X_FACE);
        break;
    case FIELD_mass_flux_y:
        UNPACK_CUDA_BUFFERS(mass_flux_y, Y_FACE);
        break;
    default:
        DIE("Invalid which_array identifier '%d' passed to CUDA - valid range is %d-%d", which_array, FIELD_density0, FIELD_mass_flux_y);
    }
...
int CloverleafCudaChunk::getBufferSize(int edge, int depth, int x_inc, int y_inc)
{
    int region[2];
...
void CloverleafCudaChunk::pack_left_right(PACK_ARGS)
{
    CHECK_PACK(pack, CHUNK_LEFT, CHUNK_RIGHT);
}

void CloverleafCudaChunk::unpack_left_right(PACK_ARGS)
{
    CHECK_PACK(unpack, CHUNK_LEFT, CHUNK_RIGHT);
}

void CloverleafCudaChunk::pack_top_bottom(PACK_ARGS)
{
    CHECK_PACK(pack, CHUNK_BOTTOM, CHUNK_TOP);
}

void CloverleafCudaChunk::unpack_top_bottom(PACK_ARGS)
{
